...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div id="_Title" class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel Div_Shadow">
                    <div class="x_content">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12 _select padding-left-right-4">
                                ...
                                <div class="dashboard_graph x_panel">
                                    <div class="x_content">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 flex-align col-style">
                                            ...
                                            <div class="col-md-8 col-sm-9 col-xs-8">
                                                <div class="col-md-7 col-sm-7 col-xs-6 flex-align padding-right-4">
                                                ...
                                                <div class="col-md-5 col-sm-5 col-xs-6 padding-right-0">
    ...
    <script>
        ...
        //產生表格的HTML碼
        create_tablehtmlcode('UntradedCustomer', '未交易客戶列表', 'table-form', '<%=th.ToString() %>', '<%=tr.ToString()%>');
        //產生相對應的JScode
