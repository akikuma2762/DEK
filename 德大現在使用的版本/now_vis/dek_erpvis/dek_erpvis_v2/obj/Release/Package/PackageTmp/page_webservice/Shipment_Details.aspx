<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="Shipment_Details.aspx.cs" Inherits="dek_erpvis_v2.page_webservice.Shipment_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="right_col" role="main" style="height:930px;">
        ...
        <ol class="breadcrumb_">
            ...
            <li><u><a href="../dp_SD/shipment.aspx">出貨統計表</a></u></li>
            <li>出貨統計明細</li>
        </ol>
<br>
                    ...
                    $(xml).find("ROOT_PIE").each(function (i) {
                        if ($(xml).find("ROOT_PIE").length > 0) {
                            ...
                            $(this).children().each(function (j) {
                                ...
                                //addData.push($(this).attr("訂單號碼").valueOf());
