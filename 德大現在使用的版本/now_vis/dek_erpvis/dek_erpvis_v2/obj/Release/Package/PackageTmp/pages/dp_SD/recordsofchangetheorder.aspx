...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        //產生表格的HTML碼
        create_tablecode('recordsofchangetheorder', '訂單變更紀錄列表', 'table-form', '<%=th.ToString() %>', '<%=tr.ToString() %>');
        //產生相對應的JScode
        set_Table('#table-form');
        //防止頁籤跑版
        loadpage('recordsofchangetheorder=recordsofchangetheorder_cust', '#table-form');
