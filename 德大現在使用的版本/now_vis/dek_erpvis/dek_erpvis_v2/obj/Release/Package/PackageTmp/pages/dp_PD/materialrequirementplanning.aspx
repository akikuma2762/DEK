...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                    ...
                                    <div class="x_content">
                                        <asp:PlaceHolder ID="PlaceHolder_hide" runat="server">
                                            <div class="col-md-12 col-sm-6 col-xs-12">
                                                ...
                                                <div class="col-md-7 col-sm-9 col-xs-8">
                                                    <div class="row">
                                                        <asp:DropDownList ID="dropdownlist_Factory" runat="server" CssClass="btn btn-default dropdown-toggle" Style="margin-left: 5px; width: 93%">
                                        ...
                                        <div class="col-md-12 col-xs-12 col-sm-12">
                                            <div class="col-md-5 col-xs-12 col-sm-6 col-xs-6">
                                                ...
                                                <asp:DropDownList ID="DropDownList_selectedcondi" Font-Names="NotoSans" Style="width: 95%" runat="server" CssClass="btn btn-default dropdown-toggle">
                                            ...
                                            <div class="col-md-7 col-xs-12 col-sm-6 col-xs-6" style="margin: 0px 0px 0px -5px">
                                                <div class="row">
                                                    <div id="input_keyword">
                                                        <asp:TextBox ID="TextBox_keyword" data-validate-length-range="6" data-validate-words="2" runat="server" Width="94%" placeholder="請輸入字串" Style="margin-left: 9px"></asp:TextBox>
                                                    </div>
                                                    <div id="warp_droplist" style="display: initial;">
                                                        <asp:DropDownList ID="DropDownList_materialstype" Font-Names="NotoSans" runat="server" Width="94%" CssClass="btn btn-default dropdown-toggle" Style="margin-left: 9px">
                                        ...
                                        <div class="col-md-12 col-xs-12 col-sm-6 col-xs-12">
                                            <div class="col-md-5 col-xs-12 col-sm-6 col-xs-6" style="margin: 3px 0px 0px 0px">
                                                <asp:DropDownList ID="DropDownList_substring" Font-Names="NotoSans" Style="width: 95%" runat="server" CssClass="btn btn-default dropdown-toggle" onchange="getval(this);">
                                            ...
                                            <div class="col-md-7 col-xs-12 col-sm-6 col-xs-6">
                                                <div id="input_subs" style="margin: 0px 0px 0px -5px">
                                                    <p></p>
                                                    <asp:TextBox ID="TextBox_substring" Font-Names="NotoSans" CssClass="form-control text-center" runat="server" Width="100%" placeholder="只能輸入數字" TextMode="Number" Enabled="false" min="12" max="99" Text="12"></asp:TextBox>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        function change_Radio() {
            try {
                relocation($('#<%=RadioButtonList_select_type.ClientID %> input:checked').val());
            }
            catch {
        ...
        function checkthetextcount(id) {
            ...
            var selValue = $('#<%=RadioButtonList_select_type.ClientID%> input:checked').val();
            var re = /^[0-9]+$/;
            //----------------------------------------
            if (selected == "Y") {
                if (text_count != "") {
        ...
        $('#<%=RadioButtonList_select_type.ClientID%> input').change(function () {
            relocation($(this).val());
        });
